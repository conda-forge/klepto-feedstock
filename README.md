...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/klepto-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11650&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/klepto-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `klepto` can be installed with:

```
conda install klepto
```

It is possible to list all of the versions of `klepto` available on your platform with:
